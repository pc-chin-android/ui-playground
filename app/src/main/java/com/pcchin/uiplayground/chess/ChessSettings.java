...
import com.pcchin.uiplayground.gamedata.AppCompatPreferenceActivity;
 ...
 */
public class ChessSettings extends AppCompatPreferenceActivity {
            ...
            if (preference instanceof ListPreference) {
                ...
                preference.setSummary(
                        index >= 0
                                ...
                                : null);
            } else if (preference.getLayoutResource() == R.layout.layout_slider) {
                // For difficulty slider, display percentage accordingly
            } else {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), ChessSettings.class));
                return true;
            }
